...
$stmt = $conn->prepare("select * from student_work_exp swe inner join student_personal sp on swe.student_id=sp.student_id where swe.wexp_type= 'internship' order by swe.wexp_id desc");
$stmt->execute();
